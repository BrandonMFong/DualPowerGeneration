<?php
    ...
    echo "<a href=\"https://github.com/Dual-Power-Generation/DualPowerGeneration\">Open Source</a>";
    ...
    echo "<a href=\"". $page_DataCenter . "\">Data Center</a>";
    echo "<a href=\"". $page_Slides . "\">Slides</a>";
