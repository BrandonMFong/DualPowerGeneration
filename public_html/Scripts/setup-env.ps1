...
# WARNING: This does delete all folders in c:\xampp\htdocs
# Assumptions:
...
try 
{
    # This is where it is by default
...
try 
{
    ...
    $replace = 'B:\\COLLEGE\\19_20\\Fall_19\\CompE_496A\\DualPowerGeneration\\'; # file path before the public_html directory
    
    $xampp_dir = 'C:\xampp\htdocs\'; # where xampp is to debug php scripts
    $xampp = 'C:\xampp\'; # xampp folder
    
    # run in ps @ gitrepo: pwd |%{$_.Path}|%{$_ + '\'}|scb
    $base_dir = 'B:\COLLEGE\19_20\Fall_19\CompE_496A\DualPowerGeneration\'; # file path before the public_html directory
    
    $repo_name = 'PUBLIC_HTML'; # the directory you are debugging 
