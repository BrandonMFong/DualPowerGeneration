...
(
	...
	DP_User_ID varchar(50)
);

create table DP_User_Membership
(
	DP_User_ID_fk varchar(50),
...
insert into DP_Users (FirstName, LastName, DP_User_ID)
value
...
insert into DP_User_Bio (DP_User_ID_fk, Description)
value
	...
	('raizen.elia', 'E.E. primarily interested in power and communications, desired to work in a team to solve and find solutions for complex problems. Currently a student Engineer at the City of San Diego, water system operation(PUD). First in my family to get a bachelor’s in Engineering. My other interests outside of School is playing soccer and cooking.'),
...
insert into DP_User_Membership (DP_User_ID_fk, Password)
value (); -- TODO for Abdullah 